...
old_Advertisements$ads_id <- as.integer(old_Advertisements$ads_id)
old_Customers$cust_id <- as.integer(old_Customers$cust_id)
old_Order_items$order_item_id <- as.integer(old_Order_items$order_item_id)
old_Orders$order_id <- as.integer(old_Orders$order_id)
old_Payments$payment_id <- as.integer(old_Payments$payment_id)
old_Products$product_id <- as.integer(old_Products$product_id)
old_Shipments$shipment_id <- as.integer(old_Shipments$shipment_id)
old_Suppliers$supplier_id <- as.integer(old_Suppliers$supplier_id)
...
Customers$cust_id <- as.integer(Customers$cust_id)
Order_items$order_item_id <- as.integer(Order_items$order_item_id)
Orders$order_id <- as.integer(Orders$order_id)
Payments$payment_id <- as.integer(Payments$payment_id)
Products$product_id <- as.integer(Products$product_id)
Shipments$shipment_id <- as.integer(Shipments$shipment_id)
Suppliers$supplier_id <- as.integer(Suppliers$supplier_id)
