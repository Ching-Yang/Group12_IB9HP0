...
![Figure 1: E-R Diagram](Report_images/E-R_Diagram.png){fig-align="center"}
...
![Figure 2: Customer Referral relationship](Report_images/refer.jpeg){fig-align="center" width="302"}
...
![Figure 3: Customer and Orders relationship](Report_images/cust_order.jpeg){fig-align="center" width="339"}
...
![Figure 4: Suppliers and Products relationship](Report_images/supp_pd.jpeg){fig-align="center" width="350"}
...
![Figure 5: Order items and Products relationship](Report_images/order_item_pd.jpeg){fig-align="center" width="365"}
...
![Figure 6: Order items and Payments relationship](Report_images/order_pay.jpeg){fig-align="center" width="343"}
...
![Figure 7: Order items and Shipments relationship](Report_images/order_ship.jpeg){fig-align="center" width="344"}
...
![Figure 8: Suppliers and Advertisements relationship](Report_images/Supp_ads.jpeg){fig-align="center" width="316"}
...
![Figure 9: UK Postcode generation](Report_images/postcode.jpeg){fig-align="center" width="497"}
...
GitHub workflows streamline the software development lifecycle, making it more efficient, reliable, and collaborative. To collaborate out the e-commerce project as a team, we created a Github account. \[User id & link\] with the repository called "xxxxxx" \[Insert link\]

\[Inset Github Repository picture contains datafiles - db, scripts\]
...
For our e-commerce project, we chose "plot.R" to plot the graphs and "up.R" to update the database and by automating them, we set up the workflow which contains steps in the figure below.

\[attach screenshot of workflow stages\]

To show that we have set the validation for the new data, Figure xx illustrates what would happened if we put in data that failed the checks, compared to the qualified ones.

\[Attach comparisons pic\]
...
We begin with data preparation by creating the data frame for the three joint tables.
...
From the result, it could be seen that the majority of the sellers in e-commerce database is "Individual". This is a useful information for the platform.
...
```{r}
# Create a data frame for shipment. Information of city, longitude and latitude from maps csv
...
Based on the result, the heatmap shows where shipment mostly located. This figure is useful for the e-commerce company if the company would like to establish the delivery hub, which should be located where customer located the most based on the delivery information.
...
The category plot allows us to observe which categories people purchase the most in each month. This is beneficial to the platform to launch the campaign on each month based on the data.
